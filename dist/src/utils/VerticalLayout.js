...
export function VerticalLayout(props) {
    const { t } = useI18n();
    return (_jsxs("div", { className: "flex flex-col h-screen", children: [_jsx("header", { className: "flex justify-between bg-base-200 text-black p-0", children: props.menu?.map((submenu, index) => _jsx("ul", { className: "menu menu-horizontal p-1", children: submenu.map((item, subIndex) => {
                        if (item.key === "home") {
