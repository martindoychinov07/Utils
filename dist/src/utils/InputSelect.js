...
export function InputSelect(props) {
    ...
    return (_jsxs("label", { className: toClassName(cn), ...dataTooltip, children: [prefix && _jsx("span", { className: "label", children: prefix }), _jsx("select", { ...register(props.name, props.rules), disabled: props.disabled, className: "field-input", autoComplete: props.autoComplete, children: options?.map((opt, index) => (_jsx("option", { value: opt.value, disabled: opt.disabled, children: t(opt.label) }, opt.value ?? index))) }, `${props.name}_${options?.length}`)] }));
}
